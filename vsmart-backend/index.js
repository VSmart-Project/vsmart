...
const startServer = () => {
    ...
    console.log(`   DynamoDB     : ${process.env.DYNAMODB_DEVICES_TABLE || 'Vsmart-Devices'}`);
    console.log(`   Tracker      : ${process.env.LOCATION_TRACKER_NAME || 'Vsmart-Tracker'}`);
