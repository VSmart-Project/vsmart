...
## Corpus Check
- 193 files · ~1,565,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1423 nodes · 1795 edges · 114 communities (91 shown, 23 thin omitted)
...
}, authRoutes, cors, deviceRoutes, { errorHandler, notFoundHandler }, express (+26 more)
...
Cohesion: 0.10
Nodes (14): App(), Toast(), DeviceMarkers(), GeofenceManagement(), Header(), menuItems, Sidebar(), DevicesMapOverlay() (+6 more)
...
Cohesion: 0.14
Nodes (8): antitheftApi, deviceApi, DashboardView(), PRESET_ROUTES, DeviceDetailPanel(), EVENT_ICONS, COGNITO, MAP
