...
|----------|-------------|---------|
| `TRACKER_NAME` | Amazon Location Tracker name | `Vsmart-Tracker` |
...
aws lambda create-function \
  ...
  --environment Variables={TRACKER_NAME=Vsmart-Tracker}
...
# Invoke function
aws lambda invoke \
  --function-name Vsmart-IoTMessageProcessor \
...
response = lambda_client.invoke(
    FunctionName='Vsmart-IoTMessageProcessor',
...
aws logs tail /aws/lambda/Vsmart-IoTMessageProcessor --follow

# Get recent errors
aws logs filter-log-events \
  --log-group-name /aws/lambda/Vsmart-IoTMessageProcessor \
...
aws cloudwatch get-metric-statistics \
  ...
  --dimensions Name=FunctionName,Value=Vsmart-IoTMessageProcessor \
...
aws iam get-role-policy \
  --role-name Vsmart-IoTLambdaRole \
